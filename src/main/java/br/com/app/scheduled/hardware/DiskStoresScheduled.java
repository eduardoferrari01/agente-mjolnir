...
@Component
public class DiskStoresScheduled implements InitializingBean, SchedulingTasks{
	...
	public void afterPropertiesSet() throws Exception {
		coleta = new DiskStoresCollect();
		requestColeta = new RequestColeta(RequestMappingEnum.DISK_STORES);
