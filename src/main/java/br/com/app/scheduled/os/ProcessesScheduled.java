...
import br.com.app.coleta.os.ProcessesCollect;
import br.com.app.scheduled.SchedulingTasks;

@Component
public class ProcessesScheduled  implements InitializingBean, SchedulingTasks{
	...
	public void afterPropertiesSet() throws Exception {
		...
		coleta = new ProcessesCollect();
		requestColeta = new RequestColeta(RequestMappingEnum.PROCESSES);
