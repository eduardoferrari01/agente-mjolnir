...
@Component
public class VersionInfoSheduled implements InitializingBean, SchedulingTasks{
	...
	public void afterPropertiesSet() throws Exception {
		...
		coleta = new VersionInfoCollect();
		requestColeta = new RequestColeta(RequestMappingEnum.VERSION_INFO);
